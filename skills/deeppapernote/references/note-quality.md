...
- It has no dedicated `Key Contributions` section and leaves the paper's novelty scattered across the note.
...
When abstract metadata exists, strong notes should also make `Original Abstract Translation` a faithful Chinese translation of the abstract:
...
- keep this section as `Original Abstract Translation`, not a bilingual original-plus-translation block
